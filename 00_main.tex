...
\title{\huge\textbf{Essay Title} \\\Large \textbf{Optional Essay Subtitle}}
\author{\Large
Author 1, Author 1 Student ID, \href{mailto:author1@uni-muenster.de}{author1@uni-muenster.de} \\
\Large (Author 2) }
