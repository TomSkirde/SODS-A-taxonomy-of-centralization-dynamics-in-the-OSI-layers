...
\label{sec:Cross-Layer_Analysis}

%#############################6.1
\subsection{The vertical centralization cascade}
Most important pattern: How centralization at one layer causes centralization at other layers as a side effect.
%#############################6.2
\subsection{The efficiency-fragility trade-off}
...
%#############################6.3
\subsection{The illusion of decentralization and re-centralization}
Technologies like Bitcoin are architecturally decentralized at their protocol layer but have seen centralization emerge in practice at other layers e.g. mining pools and major exchanges.